...
@FunctionName NVARCHAR (MAX), @FakeFunctionName NVARCHAR (MAX), @FunctionObjectId INT OUTPUT, @FakeFunctionObjectId INT OUTPUT, @IsScalarFunction BIT OUTPUT
AS
BEGIN
    ...
    IF (@FakeFunctionObjectId IS NULL)
        ...
        END
    DECLARE @FunctionType AS CHAR (2);
    DECLARE @FakeFunctionType AS CHAR (2);
