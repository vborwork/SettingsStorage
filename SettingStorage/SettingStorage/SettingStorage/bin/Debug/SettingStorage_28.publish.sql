...
GO
/*
The column [dbo].[tb_UserSettingDataType].[Type] is being dropped, data loss could occur.
*/

IF EXISTS (select top 1 1 from [dbo].[tb_UserSettingDataType])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering [dbo].[tb_UserSettingDataType]...';


GO
ALTER TABLE [dbo].[tb_UserSettingDataType] DROP COLUMN [Type];
